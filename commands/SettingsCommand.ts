...
export default {
	slashData: new SlashCommandBuilder().setName("settings").setDescription("Change server settings")
		...
		.addSubcommand(sub => sub.setName("settag").setDescription("Set the clan tag").addStringOption(option => option.setName("tag").setDescription("The tag to set").setMaxLength(10).setRequired(true)))
